...
class Reservation(Base):
    ...
    guest_id = Column('Гость', ForeignKey('Гость.Код_гостя'))
    room_id = Column('Номер', ForeignKey('Номер.Код_номера'))
    ...
    roommate_id = Column('Сожитель', ForeignKey('Сожитель.Код_сожителя'))
    payment_id = Column('Оплата', ForeignKey('Оплата.Код_оплаты'))
    room = relationship("Room", back_populates='reservations')
    guest = relationship("Guest", back_populates='reservations')
    roommate = relationship("Roommate", back_populates='reservations')
...
class Roommate(Base):
    ...
    reservations = relationship("Reservation", back_populates='roommate')
